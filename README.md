...
- If you want to run the .pyc file, then you need to install, ideally, Python version 3.8.2 32bit (or above, from https://www.python.org/downloads/). This file can be run from command line as well, e.g., under Windows cmd using the command (assumed that you already add python to the path): 
