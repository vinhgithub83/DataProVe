...
- If you want to run the .pyc file, then you need to install, ideally, Python version 3.8.5 (or above, from https://www.python.org/downloads/). This file can be run from command line as well, using command python <replace_with_pathtofile>/DataProVe-v0.9.pyc. 
